      ...
      <div className="relative mx-auto max-w-[1700px] px-5 py-8">
        ...
        {currentStep === 2 && (
          <section>
            ...
            <section className="rounded-3xl border border-white/10 bg-white/10 p-5 shadow-2xl backdrop-blur-xl">
              <SortableTeamList
                teams={thirdPlaceRanking}
                onChange={(newTeams) => {
                  setThirdPlaceRanking(newTeams);
                  setWinnersByMatch({});
                  setShareUrl("");
                }}
              />
              ...
              <p className="mt-4 text-sm text-slate-300">
                The first 8 teams in this list advance. The bottom 4 are
                eliminated.
              </p>
            </section>
          </section>
